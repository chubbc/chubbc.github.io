...
function makearXiv(feed)
{
    ...
    if (arxiv_includeTitle !== 0) {
	    ...
	    html += '<h3 style="padding-bottom:2px; margin-bottom:3px; text-align:center; font-size:200%;"> Papers</h3>\n';
    }
    ...
    for (x=0; x<num_entries; x++) {
	    ...
	    if (arxiv_includeSubjects) {
		    html += '\t\t<div class="list-subjects" style="font-size:75%;"><span class="descriptor">Subjects:</span> <span class="primary-subject" style="font-weight:bold;">' + feed.entries[x].subject + '</span>';
	    ...
	    if (arxiv_includeSummary != 0) {
		    html += '\t\t<p style="font-size:75%">' + feed.entries[x].summary + '</p>\n';
	    }
